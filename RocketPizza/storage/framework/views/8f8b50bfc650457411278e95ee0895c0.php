				...
				<div class="shop__item">
					<div class="item__border">
						...
						<div class="item__bottom">
							...
							<a class="button item-button" href="<?php echo e(url('add-to-cart/'.$item->id)); ?>">
								В кошик
							</a>
						</div>
					</div>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\example-app\resources\views/dessert.blade.php ENDPATH**/ ?>